proc cr_bd_LegoFPGA_RDM_seg_for_pcie_raw { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name LegoFPGA_RDM_seg_for_pcie_raw
...
# End of cr_bd_LegoFPGA_RDM_seg_for_pcie_raw()
cr_bd_LegoFPGA_RDM_seg_for_pcie_raw ""
set_property IS_MANAGED "0" [get_files LegoFPGA_RDM_seg_for_pcie_raw.bd ]
set_property REGISTERED_WITH_MANAGER "1" [get_files LegoFPGA_RDM_seg_for_pcie_raw.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files LegoFPGA_RDM_seg_for_pcie_raw.bd ]
