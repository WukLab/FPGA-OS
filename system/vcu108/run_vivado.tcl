...
#
# Proc to create BD LegoFPGA_KVS_for_pcie_all
...
# Proc to create BD LegoFPGA_RDM_seg_for_pcie
proc cr_bd_LegoFPGA_RDM_seg_for_pcie { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name LegoFPGA_RDM_seg_for_pcie
...
proc create_hier_cell_MC { parentCell nameHier } {
  ...
  # Create instance: rdm_segment_0, and set properties
  set rdm_segment_0 [ create_bd_cell -type ip -vlnv wuklab:hls:rdm_segment:1.0 rdm_segment_0 ]
  ...
  connect_bd_intf_net -intf_net axi_datamover_0_M_AXIS_MM2S [get_bd_intf_pins axi_datamover_0/M_AXIS_MM2S] [get_bd_intf_pins rdm_segment_0/DRAM_rd_data]
  connect_bd_intf_net -intf_net axi_datamover_0_M_AXIS_MM2S_STS [get_bd_intf_pins axi_datamover_0/M_AXIS_MM2S_STS] [get_bd_intf_pins rdm_segment_0/DRAM_rd_status_V_V]
  connect_bd_intf_net -intf_net axi_datamover_0_M_AXIS_S2MM_STS [get_bd_intf_pins axi_datamover_0/M_AXIS_S2MM_STS] [get_bd_intf_pins rdm_segment_0/DRAM_wr_status_V_V]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins MC/C0_DDR4_S_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins rdm_segment_0/from_net]
  ...
  connect_bd_intf_net -intf_net buddy_allocator_0_alloc_ret_V [get_bd_intf_pins buddy_allocator_0/alloc_ret_V] [get_bd_intf_pins rdm_segment_0/alloc_ret_V]
  ...
  connect_bd_intf_net -intf_net ddr4_0_C0_DDR4 [get_bd_intf_ports ddr4_sdram_c1] [get_bd_intf_pins MC/ddr4_sdram_c1]
  connect_bd_intf_net -intf_net rdm_segment_0_DRAM_rd_cmd_V [get_bd_intf_pins axi_datamover_0/S_AXIS_MM2S_CMD] [get_bd_intf_pins rdm_segment_0/DRAM_rd_cmd_V]
  connect_bd_intf_net -intf_net rdm_segment_0_DRAM_wr_cmd_V [get_bd_intf_pins axi_datamover_0/S_AXIS_S2MM_CMD] [get_bd_intf_pins rdm_segment_0/DRAM_wr_cmd_V]
  connect_bd_intf_net -intf_net rdm_segment_0_DRAM_wr_data [get_bd_intf_pins axi_datamover_0/S_AXIS_S2MM] [get_bd_intf_pins rdm_segment_0/DRAM_wr_data]
  connect_bd_intf_net -intf_net rdm_segment_0_alloc_req_V [get_bd_intf_pins buddy_allocator_0/alloc_V] [get_bd_intf_pins rdm_segment_0/alloc_req_V]
  connect_bd_intf_net -intf_net rdm_segment_0_to_net [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins rdm_segment_0/to_net]

  # Create port connections
  connect_bd_net -net M00_ARESETN_1 [get_bd_ports mc_ddr4_ui_clk_rst_n] [get_bd_pins MC/c0_ddr4_ui_clk_rstn] [get_bd_pins axi_interconnect_0/M00_ARESETN]
  connect_bd_net -net MC_c0_ddr4_ui_clk [get_bd_pins MC/c0_ddr4_ui_clk] [get_bd_pins axi_interconnect_0/M00_ACLK]
  connect_bd_net -net RX_clk_1 [get_bd_ports RX_clk] [get_bd_pins axi_datamover_0/m_axi_mm2s_aclk] [get_bd_pins axi_datamover_0/m_axi_s2mm_aclk] [get_bd_pins axi_datamover_0/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_awclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins buddy_allocator_0/ap_clk] [get_bd_pins rdm_segment_0/ap_clk]
  connect_bd_net -net RX_rst_n_1 [get_bd_ports RX_rst_n] [get_bd_pins axi_datamover_0/m_axi_mm2s_aresetn] [get_bd_pins axi_datamover_0/m_axi_s2mm_aresetn] [get_bd_pins axi_datamover_0/m_axis_mm2s_cmdsts_aresetn] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins buddy_allocator_0/ap_rst_n] [get_bd_pins rdm_segment_0/ap_rst_n]
  connect_bd_net -net mc_ddr4_wrapper_c0_init_calib_complete_0 [get_bd_ports mc_init_calib_complete] [get_bd_pins MC/c0_init_calib_complete_0]
  connect_bd_net -net sys_rst_0_1 [get_bd_ports sys_rst] [get_bd_pins MC/sys_rst]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins buddy_allocator_0/ap_start] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces axi_datamover_0/Data_MM2S] [get_bd_addr_segs MC/mc_ddr4_core/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_mc_ddr4_core_C0_DDR4_ADDRESS_BLOCK
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces axi_datamover_0/Data_S2MM] [get_bd_addr_segs MC/mc_ddr4_core/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_mc_ddr4_core_C0_DDR4_ADDRESS_BLOCK
...
# End of cr_bd_LegoFPGA_RDM_seg_for_pcie()
cr_bd_LegoFPGA_RDM_seg_for_pcie ""
set_property IS_MANAGED "0" [get_files LegoFPGA_RDM_seg_for_pcie.bd ]
set_property REGISTERED_WITH_MANAGER "1" [get_files LegoFPGA_RDM_seg_for_pcie.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files LegoFPGA_RDM_seg_for_pcie.bd ]
...
# Proc to create BD LegoFPGA_RDM_for_pcie_all
