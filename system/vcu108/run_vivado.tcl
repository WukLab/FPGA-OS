...
set files [list \
 ...
 [file normalize "${origin_dir}/tb/rdm/bd_rdm_tb.v"] \
...
# Proc to create BD LegoFPGA_axis_RDM_mapping
proc cr_bd_LegoFPGA_axis_RDM_mapping { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name LegoFPGA_axis_RDM_mapping
...
# End of cr_bd_LegoFPGA_axis_RDM_mapping()
cr_bd_LegoFPGA_axis_RDM_mapping ""
set_property IS_MANAGED "0" [get_files LegoFPGA_axis_RDM_mapping.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files LegoFPGA_axis_RDM_mapping.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files LegoFPGA_axis_RDM_mapping.bd ] 
