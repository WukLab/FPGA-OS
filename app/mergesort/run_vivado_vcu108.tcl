...
# Proc to create BD mergesort_top
proc cr_bd_mergesort_top { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name mergesort_top
  ...
  # Create instance: mapping_ip_top_0, and set properties
  set mapping_ip_top_0 [ create_bd_cell -type ip -vlnv wuklab:user:mapping_ip_top:1.0 mapping_ip_top_0 ]

  # Create instance: mergesort_0, and set properties
  set mergesort_0 [ create_bd_cell -type ip -vlnv wuklab:hls:mergesort:1.0 mergesort_0 ]
  ...
  connect_bd_intf_net -intf_net axi_crossbar_0_M00_AXI [get_bd_intf_pins axi_crossbar_0/M00_AXI] [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI]
  connect_bd_intf_net -intf_net ddr4_0_C0_DDR4 [get_bd_intf_ports ddr4_sdram_c1] [get_bd_intf_pins ddr4_0/C0_DDR4]
  connect_bd_intf_net -intf_net mapping_ip_top_0_M00_AXI_0 [get_bd_intf_pins axi_crossbar_0/S01_AXI] [get_bd_intf_pins mapping_ip_top_0/M00_AXI_0]
  connect_bd_intf_net -intf_net mapping_ip_top_0_out_read_0 [get_bd_intf_pins mapping_ip_top_0/out_read_0] [get_bd_intf_pins mergesort_0/map_ret_V]
  connect_bd_intf_net -intf_net mergesort_0_m_axi_dram_V [get_bd_intf_pins axi_crossbar_0/S00_AXI] [get_bd_intf_pins mergesort_0/m_axi_dram_V]
  connect_bd_intf_net -intf_net mergesort_0_map_req_V [get_bd_intf_pins mapping_ip_top_0/in_read_0] [get_bd_intf_pins mergesort_0/map_req_V]

  # Create port connections
  connect_bd_net -net c0_sys_clk_i_0_1 [get_bd_ports c0_sys_clk_i_0] [get_bd_pins ddr4_0/c0_sys_clk_i]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins axi_crossbar_0/aclk] [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins mapping_ip_top_0/ap_clk] [get_bd_pins mergesort_0/ap_clk]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins axi_crossbar_0/aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins mapping_ip_top_0/ap_rstn] [get_bd_pins mergesort_0/ap_rst_n] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins mapping_ip_top_0/in_write_0_tvalid] [get_bd_pins mapping_ip_top_0/out_write_0_tready] [get_bd_pins xlconstant_0/dout]
...
# End of cr_bd_mergesort_top()
cr_bd_mergesort_top ""
set_property IS_MANAGED "0" [get_files mergesort_top.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files mergesort_top.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files mergesort_top.bd ] 
