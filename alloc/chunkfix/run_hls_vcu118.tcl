...
# Export IP block
export_design -format ip_catalog -display_name "Fixed-size Chunk Allocator" -description "ALLOC_CHUNKFIX" -vendor "wuklab" -version "1.0"
